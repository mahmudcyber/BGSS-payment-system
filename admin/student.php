 ...
 ?>
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="btn mb-3">
      <a type="submit" href="add_student.php" class="" style="margin-left: 500px; margin-top: 20px; padding: 10px; background-color:#8b4513; color: white; border-radius:10px;"><i class="fa fa-plus"></i>Add Student</a>
    </div>
      <?php echo $err; ?>
