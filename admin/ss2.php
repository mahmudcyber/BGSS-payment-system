...
$err = "";
$query =  "SELECT * FROM student  where class =  'ss2'";
 ...
 ?>
  <div class="container-fluid">
    <h1 class="mt-4">Science Secondary School Birning Gwari Payments System</h1>
	  <hr class="color_line">
    <div class="row">
      <h3>SS2 Payments Records</h3>
      <?php echo $err; ?>
		<div class="table-responsive" >
      <table class="table table-striped table-bordered table-hove" id="example2" style="font-size: 14px;">
		  <thead>
        <tr>
          <td>S/N</td>
          <td>Student ID</td>
